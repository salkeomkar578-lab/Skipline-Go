...
export const MOCK_PRODUCTS: Product[] = [
  ...
  { 
    ...
    price: 275, 
    category: 'Breakfast', 
    image: 'https://images.unsplash.com/photo-1517093728432-a0440f8d45af?w=400&q=80',
    icon: '🥣',
    aisle: 'Aisle 4', 
  ...
  { 
    ...
    price: 145, 
    category: 'Spices', 
    image: 'https://images.unsplash.com/photo-1518110925495-5fe2f8cbf7f1?w=400&q=80',
    icon: '🧂',
    aisle: 'Aisle 17', 
  ...
  { 
    ...
    price: 125, 
    category: 'Baking', 
    image: 'https://images.unsplash.com/photo-1580910051074-52fc82a4e572?w=400&q=80',
    icon: '🥥',
    aisle: 'Aisle 18', 
